...
class LaMDATokenizer(PreTrainedTokenizer):
    """
    Construct a LaMDA tokenizer. Based on [SentencePiece](https://github.com/google/sentencepiece).
    ...
    def build_inputs_with_special_tokens(
        ...
        - single sequence: `<pad> X </s>`
        - pair of sequences: `<pad> A </s> B </s>`
