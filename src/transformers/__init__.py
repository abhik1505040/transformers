...
try:
    ...
    _import_structure["models.lamda"].append("LaMDATokenizer")
...
try:
    ...
    _import_structure["models.lamda"].extend(
        [
            "LaMDAForCausalLM",
            "LaMDAModel",
...
if TYPE_CHECKING:
    ...
    from .models.lamda import LaMDAConfig
    ...
    try:
        ...
        from .models.lamda import LaMDATokenizer
